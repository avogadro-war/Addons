...
ashita.events.register('command', 'command_cb', function(e)
    ...
    -- Help command
    if args[2] == 'help' then
        print(chat.header('Keyring'):append(chat.message('Keyring Addon v0.4.0 - Key Item Cooldown Tracker')))
        print(chat.message(''))
...
ashita.events.register('load', 'load_cb', function()
    print(chat.header('Keyring'):append(chat.message('Keyring v0.4.0 loaded. Key item state will be initialized when ready.')))
end)
